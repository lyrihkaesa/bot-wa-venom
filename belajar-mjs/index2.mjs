    ...
    function getChatPages() {
      return qChat.results.map((page) => {
        return {
          id: page.id,
          name: page.properties.id_chat.title[0]?.text.content,
          // id_no_whatsapp: page.properties.no_whatsapp_x.relation[0]?.id,
        };
      });
    }
    
    // console.log(getChatPages());


    // Constructor Function diawaling dengan huruf KAPITAL jangan camelCase.

// Misal:
// Cunstructor Function
// function KaesaLyrih(name) {
//   this.name = "";
...
// }
// // Membuat Object
// const person = new KaesaLyrih("person");

// Constructor Inheritance (Pewarisan)
// NamaConstructor.call(this, parameter)

// // General Function
// function sinPhemallaz() {}